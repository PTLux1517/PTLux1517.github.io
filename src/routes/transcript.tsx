...
export default function Transcript() {
   ...
   return <main id="transcript">
      <div id="slider-container"><label htmlFor="zoom">zoom: </label><input id="zoom-slider" name="zoom" type="range" min="0.1" max="2.0" step="0.01" defaultValue={0.5} onChange={e => setZoom(Number(e.currentTarget.value))}/></div>
